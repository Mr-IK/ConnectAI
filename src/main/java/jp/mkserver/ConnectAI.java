...
public class ConnectAI {
    ...
    public void letOpponentMove(){
        System.out.println("あなたのターンです。 (1-7): ");
    ...
    public int minimax(int depth, int turn, int alpha, int beta){
        ...
        for(int j=0;j<=6;++j){
            ...
            if(turn==1){
                ...
                if(depth==0){
                    System.out.println("有利ポイント 「"+j+"」 = "+currentScore);
    ...
    public void playAgainstAIConsole(){
        ...
        System.out.println("あなたが先手ですか? (yes/no) ");
        ...
        while(true){
            ...
            int gameResult = gameResult(b);
            if(gameResult==1){System.out.println("AIの勝利です!");break;}
            else if(gameResult==2){System.out.println("あなたの勝利です!");break;}
            else if(gameResult==0){System.out.println("引き分けです!");break;}
